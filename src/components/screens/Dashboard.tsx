      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-[0_2px_8px_rgba(13,27,62,0.06)] border border-slate-100 overflow-hidden relative min-h-[500px] flex flex-col">
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            {/* Legend Overlay */}
            <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm p-3 rounded-lg shadow-md border border-slate-200 z-[1000]">
              <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">Legend</p>
              <div className="flex items-center space-x-2 text-xs font-medium mb-1.5 text-slate-700">
            ...
            {/* Stats overlay */}
            <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm p-3 rounded-lg shadow-md border border-slate-200 z-[1000]">
              <div className="text-xs font-bold text-[#0D1B3E] mb-1">📊 Ringkasan:</div>
              <div className="space-y-1 text-[11px] text-slate-600">
                <div className="flex justify-between space-x-4"><span>Total Proyek:</span><span className="font-bold text-[#0069D9]">8</span></div>
                <div className="flex justify-between space-x-4"><span>Anomali:</span><span className="font-bold text-[#C0392B]">4</span></div>
                <div className="flex justify-between space-x-4"><span>Bersih:</span><span className="font-bold text-[#27AE60]">4</span></div>
              </div>
            </div>
          </div>
        </div>
